...
func (r *ServiceExport) SetupWebhookWithManager(mgr ctrl.Manager) error {
...
func (r *ServiceExport) ValidateCreate() error {
	...
	if r.ObjectMeta.Name == "bad-service" {
		return fmt.Errorf("service export name cannot be 'bad-service'")
	}
